...
Main.prototype.draw = function(self) 
  ...
  local halfwindowX = (self.windowSize.width / 2) - (self.haxeLogo:getWidth() / 2);
  local halfwindowY = (self.windowSize.height / 2) - (self.haxeLogo:getHeight() / 2);
  love.graphics.draw(self.haxeLogo, halfwindowX, halfwindowY);
end
